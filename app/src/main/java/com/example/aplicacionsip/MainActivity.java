package com.example.aplicacionsip;
...
public class MainActivity extends AppCompatActivity {
    ...
    String username = "telefono1";
    String domain = "sip.antisip.com";
    String password = "llamar";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLlamar.setOnClickListener(v->{
            try {
                SipAudioCall call = sipManager.makeAudioCall(sipProfile.getUriString(), "sip:telefono2@sip.antisip.com", listener, 30);
        ...
        intent.setAction("com.example.aplicacionsip.INCOMING_CALL");
        ...
        filter.addAction("com.example.aplicacionsip.INCOMING_CALL");
    ...
    public static class IncomingCallReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if(intent.getAction().equals("com.example.aplicacionsip.INCOMING_CALL")){
